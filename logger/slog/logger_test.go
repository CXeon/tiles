...
func TestSlogLogger_StdoutOnly(t *testing.T) {
	cfg := Config{
		Filename:     "",
		EnableStdout: true,
		Level:        "debug",
...
func TestSlogLogger_FileOnly(t *testing.T) {
	tmpDir := t.TempDir()
...
func TestSlogLogger_FileAndStdout(t *testing.T) {
	tmpDir := t.TempDir()
...
func TestSlogLogger_ErrorWithNilFields(t *testing.T) {
	cfg := Config{
		Filename:     "",
		EnableStdout: true,
		Level:        "error",
...
func TestSlogLogger_LevelParsing(t *testing.T) {
	tests := []struct {
		name  string
		level string
	}{
