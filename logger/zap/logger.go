...
func NewLogger(cfg Config) logger.Logger {
	...
	encoderConfig := zappkg.NewProductionEncoderConfig()
	...
	z := zappkg.New(core, zappkg.AddCaller(), zappkg.AddCallerSkip(1))

	return &loggerImpl{logger: z.Sugar()}
}
...
func (l *loggerImpl) Debug(msg string, fields logger.Fields) {
	...
	l.logger.Debugw(msg, toKeyValues(fields)...)
}
...
func (l *loggerImpl) Info(msg string, fields logger.Fields) {
	...
	l.logger.Infow(msg, toKeyValues(fields)...)
}
...
func (l *loggerImpl) Warn(msg string, fields logger.Fields) {
	...
	l.logger.Warnw(msg, toKeyValues(fields)...)
}
...
func (l *loggerImpl) Error(msg string, err error, fields logger.Fields) {
	...
	l.logger.Errorw(msg, toKeyValues(fields)...)
}
