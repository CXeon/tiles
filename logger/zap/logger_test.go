...
func TestZapLogger_StdoutOnly(t *testing.T) {
	cfg := Config{
		Filename:     "",
		EnableStdout: true,
		Level:        "debug",
...
func TestZapLogger_FileOnly(t *testing.T) {
	tmpDir := t.TempDir()
...
func TestZapLogger_FileAndStdout(t *testing.T) {
	tmpDir := t.TempDir()
...
func TestZapLogger_ErrorWithNilFields(t *testing.T) {
	cfg := Config{
		Filename:     "",
		EnableStdout: true,
		Level:        "error",
...
func TestZapLogger_LevelParsing(t *testing.T) {
	tests := []struct {
		name  string
		level string
	}{
